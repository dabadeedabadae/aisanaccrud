<?php
$this->pageTitle = Yii::t('labels', 'Управление проектами');
...
<div class="admin-dashboard">
	<div class="admin-header">
		<h1 class="admin-title"><?= Yii::t('labels', 'Управление проектами') ?></h1>
		<div class="admin-header-actions">
			<?php echo CHtml::link(
				Yii::t('labels', 'Создать проект'),
				array('admin/projectsCreate'),
	...
	<div class="admin-content">
		<?php $this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns' => array(
				...
				array(
					'name' => 'logo',
					'header' => Yii::t('labels', 'Логотип'),
					'type' => 'raw',
					'value' => '$data->getLogoUrl() ? CHtml::image($data->getLogoUrl(), "", array("style" => "max-width: 100px; max-height: 60px;")) : "-"',
				...
				array(
					...
					'buttons' => array(
						'view' => array(
							...
							'url' => 'Yii::app()->createUrl("admin/projectsView", array("id" => $data->id))',
							'options' => array('class' => 'admin-btn-view'),
						),
						'update' => array(
							'label' => Yii::t('labels', 'Редактировать'),
							'url' => 'Yii::app()->createUrl("admin/projectsUpdate", array("id" => $data->id))',
							'options' => array('class' => 'admin-btn-edit'),
						),
						'delete' => array(
							'label' => Yii::t('labels', 'Удалить'),
							'url' => 'Yii::app()->createUrl("admin/projectsDelete", array("id" => $data->id))',
							'options' => array('class' => 'admin-btn-delete'),
							'click' => 'function(){ return confirm("' . Yii::t('labels', 'Вы уверены, что хотите удалить этот проект?') . '"); }',
						),
					),
